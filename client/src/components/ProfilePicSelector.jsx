...
export default function ProfilePicSelector({ selectedPic, setSelectedPic, onSubmit, onBack }) {
  return (
    ...
    <div className="grid grid-cols-2">
        <div>
            <h2 className="text-3xl tracking-wide text-black dark:text-white text-left mt-4">
    ...
    <div className="flex gap-5 mt-15 items-baseline-last justify-end">
        <button
            onClick={onBack}
            className="px-5 py-2 tracking-wide text-black dark:text-white rounded-2xl hover:bg-gray-300 transition-colors duration-300 font-medium"
        >
            Back
        </button>
        <button
