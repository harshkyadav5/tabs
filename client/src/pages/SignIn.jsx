            ...
            <div className="grid grid-rows-[1fr_4fr] w-full max-w-5xl h-fit p-10 rounded-4xl bg-white dark:bg-black">
                ...
                >
                    <div className="grid grid-cols-2">
                        ...
                        <div>
                            <div className="mb-4">
                                <label htmlFor="email" className="block tracking-wider pl-3 text-sm font-medium text-black dark:text-gray-200 mb-1">
                                    Email
                                </label>
                                <input
                                    type="email"
                            ...
                            <div className="mb-4">
                                <label htmlFor="password" className="block tracking-wider pl-3 text-sm font-medium text-black dark:text-gray-200 mb-1">
                                    Password
                                </label>
